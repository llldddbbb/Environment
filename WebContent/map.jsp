	    ...
	    <div class="container-fluid ">
	        ...
	        <div class="collapse navbar-collapse collapse_list" id="bs-example-navbar-collapse-1">
	            <ul class="nav navbar-nav navbar-right menu">
	                <li><a href="${pageContext.request.contextPath }/account/changeLanguage.do?language=English&fromPageName=map">中/Eng</a></li>
		...
		$.post(url,{},function(result){ 
			...
			if(result){
				$.each(result, function(i,val){
					...
					var content="<div class='mapInfo_content'><div class='mapInfo_content_left'>空气质量指数<br><span>"+val.AQIOrAQHI+"</span></div><div class='mapInfo_content_middle'>"+parseFloat(val.AQI_value).toFixed(0)+"</div><div class='mapInfo_content_right'><span>温度:"+parseFloat(val.Temp).toFixed(0)+"℃<br/>湿度:"+parseFloat(val.Humi).toFixed(0)+"%</span></div></div><table class='map-view'><tr><td >PM<sub>2.5</sub></td><td >"+parseFloat(val.PM25).toFixed(1)+
					...
					"&nbsp;ppb</td></tr></table><div class='mapInfo_foot'>最后更新时间&nbsp;&nbsp;&nbsp;"+val.TimeStamp+"<div>";
