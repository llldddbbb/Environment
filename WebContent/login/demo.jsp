...
<head>
	...
	<style>
		body{
			background: url(${pageContext.request.contextPath }/img/cityImg/back.jpg) no-repeat fixed;
		}
	</style>
...
<body>
	 <div class="login_nav">
        ...
        <a href="${pageContext.request.contextPath }/account/changeLanguage.do?language=English&fromPageName=login/demo">中 / Eng</a>
    </div><!--导航区结束-->
