	    ...
	    <div class="container-fluid ">
	        ...
	        <div class="collapse navbar-collapse collapse_list" id="bs-example-navbar-collapse-1">
	            <ul class="nav navbar-nav navbar-right menu">
	                <li><a href="${pageContext.request.contextPath }/account/changeLanguage.do?language=Chinese&fromPageName=mgmt">中/Eng</a></li>
				...
				<c:forEach var="city" items="${cityList }" varStatus="status">
					<div class="cities">
						...
						<img src="../img/cityImg/${city.picture }" alt=""/>
							...
							<label style="margin-right:5px;">Site</label><input type="text" id="cityName" name="cityName" value="${city.cityName }"/>
							<label style="margin-right:5px;">Lat</label><input type="text" id="lat" name="lat" value="${city.lat }"/>
							<label style="margin:0 5px;">Lng</label><input type="text" id="lng" name="lng" value="${city.lng }"/>
							...
							<input type="button"  value="Picture" style="folat:right;" onclick="javascript:$('#hiddenFile${status.index }').click()"/>
							...
							<input type="submit"  value="Modify" style="folat:right;"/>
							</div>
							</form>
							</div>
						</span>
