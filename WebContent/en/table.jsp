	...
	<script>
		...
		function findDeviceTable(exportExcel){
			...
			if(lineNum<=0||lineNum>50){
				alert("The number of rows per page is restricted to 1-50, please input again");
				return ;
			}
			...
			if(chk_value.length==1){
				alert("Please select the category of pollutants ");
				return;
			}
...
<body style="background:#4585d7">
	<div class="header">
		<div class="header-nav">
			...
			<div class="menu">
				<a class="header-btn" href="${pageContext.request.contextPath}/account/logout.do">Logout</a>
				<a class="header-btn" href="mgmt.jsp">Manage</a>
				<a class="header-btn" href="compare.jsp">Compare</a>
				<a class="header-btn" href="map.jsp">Map</a>
				<a class="header-btn" href="${pageContext.request.contextPath}/city/list.do?cityID=${currentAccount.place}">List</a>	
				<a class="header-btn" href="${pageContext.request.contextPath }/account/changeLanguage.do?language=Chinese&fromPageName=table">中/Eng</a>
			</div>
		</div>
	</div>
	...
	<div class="detail-main">
		<div class="detail-left">
			<a class="map-left" href="#">History Data</a>
			<a class="map-left" href="#">Alert Data</a>
			<a class="map-left" href="javascript:history.go(-1)">Back</a>	
		</div>
		...
		<div>
				...
				<div class="table-select2">site</div>
				...
				<div class="table-select2">Interval</div>
				...
				<c:choose>
					...
					<c:otherwise>
						<option value="1min" ${interval=='1min'?'selected':'' }>1min</option>
						<option value="10min" ${interval=='10min'?'selected':'' }>10min</option>
						<option value="1h" ${interval=='1h'?'selected':'' }>1h</option>
						<option value="1d" ${interval=='1d'?'selected':'' } >1d</option>
					</c:otherwise>
				</c:choose>
				...
				<div class="table-select">
				<div style="margin-top: 30px;margin-left: -25px;"><a id="detail-submit"href="${pageContext.request.contextPath }/device/detail.do?deviceName=${deviceName}&cityName=${cityName}">Graph</a></div>
				</div>
				</div>
				</div>
				...
				<div style="display:inline;">
				<div class="table-select" style="margin-left:30px;">
				<div class="table-select2">unit</div>
				...
				<div class="table-select">
				<div class="table-select2">Pollutant</div>
				...
				<div class="table-select">
				<div>&nbsp;</div>
					<input type="checkbox" name="airQulityType" id="Temp" value="Temp"  class="radio" >Temp<br>
				</div>
				<div class="table-select">
				<div>&nbsp;</div>
					<input type="checkbox" name="airQulityType" id="Humi" value="Humi"  class="radio" >Humi<br>		
				</div>
				...
				<div style="display:inline;">
					<div class="table-select" style="margin-left:30px; ">
					<div class="table-select2">Alert Data</div>
					<table style="margin-top: 0px;">
						<tr>
							...
							<td style="padding-top: 10px;">Humi&nbsp;</td>
				...
				<div style="margin-left: 30px;margin-top: 5px;">
					<input type="button" style="display:inline-block;vertical-align:top;width:100px; height:27px; font-size:10px; text-align:bottom; padding-left: 0px;" onclick="javascript:findDeviceTable(1)" value="Export Excel"/>
					<input type="button" style="display:inline-block;vertical-align:top;width:100px; height:27px; font-size:10px; text-align:bottom;padding-left: 0px;" value="Select" onclick="javascript:findDeviceTable()"/>	
				</div>
