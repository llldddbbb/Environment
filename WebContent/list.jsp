...
<body>
	    ...
	    <div class="container-fluid ">
	        ...
	        <div class="collapse navbar-collapse collapse_list" id="bs-example-navbar-collapse-1">
	            <ul class="nav navbar-nav navbar-right menu">
	                <li><a href="${pageContext.request.contextPath }/account/changeLanguage.do?language=English&fromPageName=list">中/Eng</a></li>
	...
	<%-- <div class="header">
		<div class="header-nav">
			<div class="logo">
				<span>Environmental IoT Network Cloud (SEIN)<br/>环境物联网云平台</span>
			</div>
			<div class="menu">
				...
				<a class="header-btn" href="${pageContext.request.contextPath }/account/changeLanguage.do?language=English&fromPageName=list">中/Eng</a>
			</div>
		</div>
	</div> --%>
	<div class="content">
			<div class="content-main">
				...
				<div class="searchbar" id="searchbar">
					...
					<input style="float: left" id="placesearch" type="text" placeholder="地点搜索(search)" onkeyup="if(event.keyCode==13) searchPlace();">
